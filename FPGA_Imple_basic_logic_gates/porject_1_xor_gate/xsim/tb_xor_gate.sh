...
#
# Script generated by Vivado on Mon Sep 08 23:48:11 -0500 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_xor_gate.sh
...
#
# Usage        : tb_xor_gate.sh
#                tb_xor_gate.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_xor_gate.sh [-reset_run]
#                tb_xor_gate.sh [-reset_log]
#                tb_xor_gate.sh [-help]
#
...
# script info
echo -e "tb_xor_gate.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_xor_gate.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L util_vector_logic_v2_0_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb_xor_gate xil_defaultlib.tb_xor_gate xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_xor_gate -key {Behavioral:sim_1:Functional:tb_xor_gate} -tclbatch cmd.tcl -protoinst "protoinst_files/BD_XOR_GATE.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_xor_gate.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_xor_gate.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_xor_gate.sh [-help]\n\
Usage: tb_xor_gate.sh [-step]\n\
Usage: tb_xor_gate.sh [-lib_map_path]\n\
Usage: tb_xor_gate.sh [-reset_run]\n\
Usage: tb_xor_gate.sh [-reset_log]\n\
Usage: tb_xor_gate.sh [-keep_index]\n\
Usage: tb_xor_gate.sh [-noclean_files]\n\n\
