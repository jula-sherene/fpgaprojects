...
#
# Script generated by Vivado on Thu Sep 04 10:14:15 -0500 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : TB_BD_OR_GATE.sh
...
#
# Usage        : TB_BD_OR_GATE.sh
#                TB_BD_OR_GATE.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TB_BD_OR_GATE.sh [-reset_run]
#                TB_BD_OR_GATE.sh [-reset_log]
#                TB_BD_OR_GATE.sh [-help]
#
...
# script info
echo -e "TB_BD_OR_GATE.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TB_BD_OR_GATE.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L util_vector_logic_v2_0_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TB_BD_OR_GATE xil_defaultlib.TB_BD_OR_GATE xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TB_BD_OR_GATE -key {Behavioral:sim_1:Functional:TB_BD_OR_GATE} -tclbatch cmd.tcl -protoinst "protoinst_files/OR_GATE.protoinst" -protoinst "protoinst_files/BD_XOR_GATE.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TB_BD_OR_GATE.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TB_BD_OR_GATE.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TB_BD_OR_GATE.sh [-help]\n\
Usage: TB_BD_OR_GATE.sh [-step]\n\
Usage: TB_BD_OR_GATE.sh [-lib_map_path]\n\
Usage: TB_BD_OR_GATE.sh [-reset_run]\n\
Usage: TB_BD_OR_GATE.sh [-reset_log]\n\
Usage: TB_BD_OR_GATE.sh [-keep_index]\n\
Usage: TB_BD_OR_GATE.sh [-noclean_files]\n\n\
