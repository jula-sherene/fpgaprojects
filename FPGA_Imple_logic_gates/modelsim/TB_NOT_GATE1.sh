...
#
# Script generated by Vivado on Thu Sep 04 04:04:57 -0500 2025
...
#                script (type 'TB_NOT_GATE1.sh -help' for more information).
#
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/julas/comphardwt_project_2/comphardwt_project_2.cache/compile_simlib/modelsim"
  fi
